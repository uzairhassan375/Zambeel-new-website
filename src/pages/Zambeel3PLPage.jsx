...
const Zambeel3PLPage = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden relative" style={{ background: 'linear-gradient(186.57deg, rgba(72, 11, 96, 0.75) 5.1%, rgba(31, 46, 100, 0.958277) 12.51%, rgba(28, 54, 89, 0.911419) 31.95%, rgba(53, 4, 72, 0.793286) 47.98%, rgba(51, 88, 140, 0.913498) 70.93%, #4A61C4 81.76%)' }}>
        ...
        steps={[
          {
            ...
            desktopDescription: formatDescription(t('zambeel3PL.whereToStart.steps.bookConsultation.desc')),
            icon: connectionImg,
            iconAlt: "connection"
          },
          {
            ...
            desktopDescription: formatDescription(t('zambeel3PL.whereToStart.steps.sendInventory.desc')),
            icon: frameImg,
            iconAlt: "frame"
          },
          {
            ...
            desktopDescription: formatDescription(t('zambeel3PL.whereToStart.steps.connectStore.desc')),
            icon: databaseImg,
            iconAlt: "database"
          },
          {
            ...
            desktopDescription: formatDescription(t('zambeel3PL.whereToStart.steps.startSelling.desc')),
            icon: null,
            iconAlt: null
          }
        ]}
